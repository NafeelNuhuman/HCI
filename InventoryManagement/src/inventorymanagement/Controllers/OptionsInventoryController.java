 ...
 * @author Dino
 */
public class OptionsInventoryController implements Initializable {
    ...
    @FXML
    private ToggleGroup Display, Sales;
    @FXML
    private ToggleButton description, number, barcode;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        barcode.setToggleGroup(Display);
        number.setToggleGroup(Display);
        description.setToggleGroup(Display);}
    }
